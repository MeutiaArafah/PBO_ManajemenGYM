...
public class FormPendaftaranKelas extends JFrame {
    ...
    public FormPendaftaranKelas() {
        ...
        scrollCatatan.setBounds(150, 140, 250, 60);
        add(scrollCatatan);

        // --- 3. Tombol Aksi ---
        btnSimpan = new JButton("Simpan");
        btnSimpan.setBounds(20, 220, 120, 30);
        add(btnSimpan);

        btnHapus = new JButton("Hapus");
        btnHapus.setBounds(150, 220, 120, 30);
        add(btnHapus);

        btnReset = new JButton("Reset");
        btnReset.setBounds(280, 220, 120, 30);
        add(btnReset);
    ...
    public void simpanData() {
        // validasi harus mengisi semua kolom
        ...
        // validasi tanggal
        if (!txtTanggalDaftar.getText().matches("\\d{4}-\\d{2}-\\d{2}")) {
